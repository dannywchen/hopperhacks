...
export function ClassicLoader({
  ...
  return (
    <div
      className={cn(
        "flex animate-spin items-center justify-center rounded-full border border-white border-t-transparent",
        sizeClasses[size],
        className,
      )}
    >
...
export function TextDotsLoader({
  ...
  return (
    <div className={cn("inline-flex items-center", className)}>
      <span className={cn("font-medium", textSizes[size])}>{text}</span>
